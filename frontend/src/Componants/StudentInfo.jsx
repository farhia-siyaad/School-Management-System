...
function Studentinfo(){
    ...
    const diwaangaliardeyga =(e) =>{
        ...
        axios.post("http://localhost:3000/create/student",{
            ...
            toast("Students has been registered successfully",{
                position: "top-right",
                aoutoClose: 500,
    ...
    return <div>
        ...
        <h1 className="text-3xl text-center pt-4">Regester Student</h1>
        ...
        <br />
        <button onClick={diwaangaliardeyga} className="bg-red-200 px-16  text-white rounded -ml-[730px] mt-20 py-2 text-3xl">Save Student</button>
        </form>
        <ToastContainer/>
    </div>
}
